...
async def pretty_defer(
    ...
    content: str = "Please wait while Ghouldengo thinks...",
    embed: discord.Embed | None = None,
    ephemeral: bool = True,
):
    """
    Fully safe Ghouldengo loader for interactions.
...
async def pretty_error(
    ...
    """
    Standalone ephemeral error sender for Ghouldengo.
    - Always ephemeral.
    - Uses Ghouldengo's error emoji.
