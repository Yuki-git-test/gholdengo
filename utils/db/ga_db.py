...
async def upsert_giveaway(
    ...
    """Upsert a giveaway record."""
    try:
        async with bot.pg_pool.acquire() as conn:
            await conn.execute(
                """
                INSERT INTO giveaways (message_id, channel_id, host_id, host_name, ends_at, max_winners, prize, ended, image_link, thumbnail_link, thread_id)
